...
public class DialogsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private ActionBarMenuItem itemHithere;
    private static int iCountActivities = 0;
    ...
    public View createView(final Context context) {
        ...
        //VC
        thisContext=context;
        MessagesController.getInstance().protectAllDialogs();
        ...
        //VC intercept events on Lock imageView: LongClick password to unhide, Click hide all
        itemHithere = menu.addItem(99,R.drawable.eye_closed);
        itemHithere.getImageView().setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick (View v) {
                MessagesController.getInstance().ChatUnprotectMenu(context);
                //itemHithere.setIcon(R.drawable.eye_opened);
                return true;
            }
        });
        itemHithere.getImageView().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick (View v) {
                MessagesController.getInstance().protectAllDialogs();
                //itemHithere.setIcon(R.drawable.eye_closed);
            }
        });
        ...
        listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() {
            ...
            public boolean onItemClick(View view, int position) {
                ...
                if (DialogObject.isChannel(dialog)) {
                    ...
                    //VC! Adding HideChat item in the menu and manage it!
                    if(isChat) {
                        menuItems=new CharSequence[]{
                        ...
                        if(MessagesController.getInstance().isAppConfigured()){
                            if(MessagesController.getInstance().isChatConfigured(selectedDialog)){
                                menuItems=new CharSequence[]{
                                        LocaleController.getString("ClearHistory", R.string.ClearHistory),
                                        LocaleController.getString("Delete", R.string.Delete),
                                        LocaleController.getString("ProtectChat", R.string.ProtectChat),
                                        LocaleController.getString("ChatConfig", R.string.ChatConfig)};
                            } else {
                                menuItems=new CharSequence[]{
                                        LocaleController.getString("ClearHistory", R.string.ClearHistory),
                                        LocaleController.getString("Delete", R.string.Delete),
                    ...
                    builder.setItems(menuItems,new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(final DialogInterface dialog, final int which) {
                            ...
                            } else if (menuItems[which].equals(LocaleController.getString("ProtectChat", R.string.ProtectChat))) {
                                MessagesController.getInstance().ChatProtectMenu(getParentActivity(),selectedDialog);
                            } else if (menuItems[which].equals(LocaleController.getString("ChatConfig", R.string.ChatConfig))) {
                                MessagesController.getInstance().ChatConfigMenu(getParentActivity(),selectedDialog);
                            }
                        }
                    });
                    showDialog(builder.create());
        ...
        //VC Show HiThere Splash Screen
        MessagesController.getInstance().showSplashScreen(getParentActivity());
    ...
    public void didReceivedNotification(int id, Object... args) {
        if (id == NotificationCenter.dialogsNeedReload) {
            ...
            if (listView != null) {
                //VC change Eye icon
                if(MessagesController.getInstance().bIsProtectedChatShown){
                    itemHithere.setIcon(R.drawable.eye_opened);
                    } else {
                    itemHithere.setIcon(R.drawable.eye_closed);
                }
