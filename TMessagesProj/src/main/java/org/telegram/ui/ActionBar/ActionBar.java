...
public class ActionBar extends FrameLayout {
    ...
    private void createTitleTextView() {
        ...
        //VC! Ad long click event to Title bar
        titleTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String sText = "Clicked";

            }
        });

        //VC LongClick on the Title to intercept HIThere config
        titleTextView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick (View v) {
                //MessagesController.getInstance().alertView("Funziona!",getContext());
                //MessagesController.getInstance().showSplashScreen(getContext());
                MessagesController.getInstance().HiThereConfigMenu(getContext());
                return true;
            }
        });
