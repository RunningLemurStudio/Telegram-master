...
public class MessagesStorage {
    ...
    //VC! Filter out all the dialog in hidedDialogs array
        ...
        storageQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //VC
                    MessagesController.getInstance().htAllDialogsDid.clear();
                    JSONArray hidedDialogs=MessagesController.getInstance().htCfg.getJSONArray("hidedDialogs");
                    ...
                    while (cursor.next()) {
                        ...
                        //VC! if the current dialog is contained in hidedDialogs skip
                        final Long did =cursor.longValue(0);
                        MessagesController.getInstance().htAllDialogsDid.add(did);
                        boolean bFound=MessagesController.getInstance().isDialog2Process(did,3);
                        if(bFound){
                            continue;
                        }
